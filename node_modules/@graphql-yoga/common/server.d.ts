...
import { Plugin, GetEnvelopedFn, UseMaskedErrorsOpts, PromiseOrValue } from '@envelop/core';
...
import { CORSOptions, GraphQLServerInject, YogaInitialContext, FetchAPI } from './types';
...
export declare type YogaServerOptions<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>, TRootValue> = {
    ...
    cors?: ((request: Request, ...args: {} extends TServerContext ? [serverContext?: TServerContext | undefined] : [serverContext: TServerContext]) => CORSOptions) | CORSOptions | boolean;
    /**
     * GraphQL endpoint
     */
    endpoint?: string;
     ...
     * Default: `true`
     */
    graphiql?: GraphiQLOptions | ((request: Request, ...args: {} extends TServerContext ? [serverContext?: TServerContext | undefined] : [serverContext: TServerContext]) => GraphiQLOptions | boolean) | boolean;
...
export declare class YogaServer<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>, TRootValue> {
    ...
    protected readonly graphiqlOptionsFactory: (request: Request, ...args: {} extends TServerContext ? [serverContext?: TServerContext | undefined] : [serverContext: TServerContext]) => GraphiQLOptions | boolean;
    ...
    getCORSResponseHeaders(request: Request, ...args: {} extends TServerContext ? [serverContext?: TServerContext | undefined] : [serverContext: TServerContext]): Record<string, string>;
    handleOptions(request: Request, ...args: {} extends TServerContext ? [serverContext?: TServerContext | undefined] : [serverContext: TServerContext]): Response;
    private id;
